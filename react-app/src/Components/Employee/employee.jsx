  ...
  render_button = index => {
    if (this.state.items[index].reserved) {
      ...
      return (
        ...
        >
          <img src="./images/restaurant_images/done-tick.png"></img>
        </button>
      );
    }
  };
            ...
            >
              <Card.Header className="header-of-card">
                <div className="pic-container">
                  ...
                  <img
                    className="user-pic"
                    src="./images/restaurant_images/boy.png"
                  ></img>
                </div>
              </Card.Header>
              <Card.Body>
                <div>
                  <span>
                    <img
                      className="info-png"
                      src="./images/restaurant_images/calendar.png"
                    ></img>
                ...
                <div className="num_people">
                  <span>
                    <img
                      className="info-png"
                      src="./images/restaurant_images/avatar.png"
                    ></img>
                ...
                <div className="user_profile_holder">
                  <div className="check-container">
                    <button
                      ...
                      onMouseDown={this.removefocus}
                    >
                      <img src="./images/restaurant_images/no-stopping.png"></img>
                    </button>
                  </div>
                </div>
              </Card.Body>
      ...
      <div id="outer-container" className="card-container">
              ...
              >
                <Card.Header className="header-of-card">
                  <div className="pic-container">
                    ...
                    <img
                      className="user-pic"
                      src="./images/restaurant_images/table.png"
                    ></img>
                  </div>
                </Card.Header>
                <Card.Body>
        ...
        <div id="page-wrap">
          ...
          <div id="cal" style={{ height: "80px" }}>
            ...
            <button id="date-confirm" onClick={() => this.setModalState(true)}>
              Add Reservation
            </button>
          </div>
                ...
                <Card.Body>
                  ...
                  <div>
                    <span>
                      <img
                        className="info-png"
                        src="./images/restaurant_images/receptionist.png"
                      ></img>
                  ...
                  <div className="user_profile_holder">
                    <div className="check-container">
                      ...
                      <button
                        class="reject-button"
                        onClick={e => this.remove_reservation_from_items(index)}
                        onMouseDown={this.removefocus}
                      >
                        <img src="./images/restaurant_images/no-stopping.png"></img>
                      </button>
